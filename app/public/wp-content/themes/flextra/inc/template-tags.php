...
if ( ! function_exists( 'flextra_entry_header' ) ) :
	/**
	 * Prints HTML with meta information for the categories.
	 */
	function flextra_entry_header() {
...
if ( ! function_exists( 'flextra_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the tags and comments.
	 */
	function flextra_entry_footer() {
			...
			if( !is_single() && !get_theme_mod( 'hide_comment', false ) ){ 
				...
				comments_popup_link(
					sprintf(
						wp_kses(
							...
							__( 'Comment<span class="screen-reader-text"> on %s</span>', 'flextra' ),
							array(
								'span' => array(
									'class' => array(),
								),
				...
				comments_popup_link(
					sprintf(
						wp_kses(
							/* translators: %s: post title */
							__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'flextra' ),
							array(
								'span' => array(
									'class' => array(),
								),
		...
		if ( 'post' === get_post_type() ) {
				/* translators: used between list items, there is a space after the comma */
				$categories_list = get_the_category_list( esc_html__( ', ', 'flextra' ) );
			...
			if( get_the_tag_list() ): ?>
				<div class="tag-links">
					<span class="screen-reader-text">
						<?php echo esc_html__( 'Tags', 'flextra' ); ?>
					</span>
					<?php echo get_the_tag_list( '', esc_html__( ', ', 'flextra' ) ); ?>
				</div>
			<?php endif; 
		} 
	}
...
if( !function_exists( 'flextra_get_day_link' ) ):
/**
 ...
 * @return string
 */
if ( ! function_exists( 'flextra_time_link' ) ) :

function flextra_time_link() {
...
?>
	<span class="screen-reader-text"><?php echo esc_html__( 'Posted on', 'flextra' ); ?></span>
	<span class="posted-on">
		<a href="<?php echo esc_url( flextra_get_day_link() ); ?>" rel="bookmark">
...
if ( ! function_exists( 'flextra_edit_link' ) ) :

function flextra_edit_link( $echo = true ) {
	...
	edit_post_link(
		sprintf(
			...
			__( 'EDIT<span class="screen-reader-text"> "%s"</span>', 'flextra' ),
			get_the_title()
		),
